...
import { resolverDivision } from "../Utilidades/Operaciones";
...
export class Division extends Instruccion {
    ...
    interpretar(arbol: Arbol, tabla: TablaSimbolos): any {
        ...
        if (this.operacion !== OperadoresAritmeticos.DIVISION) {
            return new Errores("Semantico", "Operador de division invalido", this.linea, this.col);
        }

        const resultado = resolverDivision(
            opIzq,
            this.operando1.tipo,
            opDer,
            this.operando2.tipo,
