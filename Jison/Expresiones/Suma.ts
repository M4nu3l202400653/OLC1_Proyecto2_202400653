...
import { resolverSuma } from "../Utilidades/Operaciones";
...
export class Suma extends Instruccion {
    ...
    interpretar(arbol: Arbol, tabla: TablaSimbolos): any {
        ...
        if (this.operacion !== OperadoresAritmeticos.SUMA) {
            return new Errores("Semantico", "Operador de suma invalido", this.linea, this.col);
        }

        const resultado = resolverSuma(
            opIzq,
            this.operando1.tipo,
            opDer,
            this.operando2.tipo,
