...
import { resolverModulo } from "../Utilidades/Operaciones";
...
export class Modulo extends Instruccion {
    ...
    interpretar(arbol: Arbol, tabla: TablaSimbolos): any {
        ...
        if (this.operacion !== OperadoresAritmeticos.MODULO) {
            return new Errores("Semantico", "Operador de modulo invalido", this.linea, this.col);
        }

        const resultado = resolverModulo(
            opIzq,
            this.operando1.tipo,
            opDer,
            this.operando2.tipo,
