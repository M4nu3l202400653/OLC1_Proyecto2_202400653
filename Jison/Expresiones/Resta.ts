...
import { resolverResta } from "../Utilidades/Operaciones";
...
export class Resta extends Instruccion {
    ...
    interpretar(arbol: Arbol, tabla: TablaSimbolos): any {
        ...
        if (this.operacion !== OperadoresAritmeticos.RESTA) {
            return new Errores("Semantico", "Operador de resta invalido", this.linea, this.col);
        }

        const resultado = resolverResta(
            opIzq,
            this.operando1.tipo,
            opDer,
            this.operando2.tipo,
